...
@gf.cell
def MZIs_Pack3()->gf.Component:
    c = gf.Component()

    sin_1250_mzi = c.add_ref(SiN_1250_MZI(gap = 500, dl = 95.437, cross_section = "strip"))
    ...
    strip_mzi = c.add_ref(strip_MZI(gap = 100, dl = 62.017, cross_section = "strip"))
    strip_mzi.ymax = via_mzi.ymin - 5
